...
public class SKActivityIndicator: NSObject {
    ...
    fileprivate var statusTextColor        : UIColor                = UIColor.init(red: 239.0/255.0, green: 82.0/255.0, blue: 93.0/255.0, alpha: 1.0)
...
//                if (notification!.name == NSNotification.Name.UIKeyboardWillShow || notification!.name == NSNotification.Name.UIResponder.keyboardDidShowNotification) {
